 ...
 * @author：
 */
public class CancelHeaderVO extends SuperVO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3355756366751650141L;
	public String m_pk_cancel;
	public String m_cancelcode;
	...
	private static StringField m_cancelcodeField;
	private static StringField m_cancelreasonField;
 ...
 */
public CancelHeaderVO(String newPk_cancel) {
 ...
 *
 * 创建日期：(2005-10-7)
 * @param m_pk_cancel String 
 */
public void setPrimaryKey(String newPk_cancel) {
...
/**
 * 属性m_cancelcode的setter方法。
 *
 * 创建日期：(2005-10-7)
 * @param newM_cancelcode String
 */
public void setCancelcode(String newCancelcode) {

	m_cancelcode = newCancelcode;
}
/**
 * 属性m_cancelreason的setter方法。
 *
 * 创建日期：(2005-10-7)
 * @param newM_cancelreason String
 */
public void setCancelreason(String newCancelreason) {

	m_cancelreason = newCancelreason;
}
/**
...
public void validate() throws ValidationException {
	...
	if (m_pk_cancel == null) {
		errFields.add(new String("m_pk_cancel"));
	}
...
public java.lang.String[] getAttributeNames() {
	...
	return new String[]{ "cancelcode", "cancelreason", "pk_maker", "makedate", "pk_checker", "checkdate", "checkflag", "tallyflag", "tallydate", "def1", "def2", "def3", "def4", "def5" };
}
/**
 *  <p>根据一个属性名称字符串该属性的值。
 *  <p>
...
public Object getAttributeValue(String attributeName) {
	...
	if (attributeName.equals("pk_cancel")) {
		return m_pk_cancel;
	}
	else if (attributeName.equals("cancelcode")) {
		return m_cancelcode;
	}
	else if (attributeName.equals("cancelreason")) {
		return m_cancelreason;
	}
...
public void setAttributeValue(String name, Object value) {
	...
	try {
		...
		if (name.equals("pk_cancel")) {
			m_pk_cancel = (String) value;
		}
		else if (name.equals("cancelcode")) {
			m_cancelcode = (String) value;
		}
		else if (name.equals("cancelreason")) {
			m_cancelreason = (String) value;
		}
 ...
 * @return nc.vo.pub.FieldObject
 */
public static StringField getCancelcodeField() {

	if(m_cancelcodeField == null){
		try{
			m_cancelcodeField = new StringField();
			// 属性的名称
			m_cancelcodeField.setName("cancelcode");
			// 属性的描述
			m_cancelcodeField.setLabel("null");
			// 请添加对本属性的期它描述：
 ...
 * @return nc.vo.pub.FieldObject
 */
public static StringField getCancelreasonField() {

	if(m_cancelreasonField == null){
		try{
			m_cancelreasonField = new StringField();
			// 属性的名称
			m_cancelreasonField.setName("cancelreason");
			// 属性的描述
			m_cancelreasonField.setLabel("null");
			// 请添加对本属性的期它描述：
...
public FieldObject[] getFields() {
	...
	FieldObject[] fields = {getPk_cancelField(), getCancelcodeField(), getCancelreasonField(), getPk_makerField(), getMakedateField(), getPk_checkerField(), getCheckdateField(), getCheckflagField(), getTallyflagField(), getTallydateField(), getDef1Field(), getDef2Field(), getDef3Field(), getDef4Field(), getDef5Field()};
